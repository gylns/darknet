...
YOLODLL_API float *network_predict_p(network *net, float *input);
...
YOLODLL_API detection *get_network_boxes_batch(network *net, int b, int w, int h, float thresh, float hier, int *map, int relative, int *num, int letter);
YOLODLL_API detection *make_network_boxes(network *net, float thresh, int *num);
YOLODLL_API detection *make_network_boxes_batch(network *net, int b, float thresh, int *num);
...
YOLODLL_API network *load_network_custom_mem(char *cfg_buffer, char *weight_buffer, int clear, int batch);
YOLODLL_API network *load_network_custom_one(char *cfg_weights, int clear, int batch);
